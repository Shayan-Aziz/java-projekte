...
/**
 * shapes.Canvas is a class to allow for simple graphical drawing on a canvas. This is
 * a modification of the general purpose shapes.Canvas, specially made for the BlueJ
 * "shapes" example.
 * 
 * @author: Bruce Quig
...
public class Canvas {
	 ...
	 * 
	 * @param title
	 *            title to appear in shapes.Canvas Frame
	 * @param width
	 ...
	 * 
	 * @param newColour
	 *            the new colour for the foreground of the shapes.Canvas
	 */
